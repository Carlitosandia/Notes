...
import { removeCategory } from '@/api/NotesAPI';

type categoriesProps = {
    categories: Category[]
}

export default function RemoveCategoryModal({ categories }: categoriesProps) {
    const navigate = useNavigate();
    const location = useLocation();
    const queryParams = new URLSearchParams(location.search);
    const modalCategory = queryParams.get('removeCategory');
